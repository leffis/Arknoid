 ...
 */
public class SmallerBall extends Eatable implements TimerObserver {

    int timeRemain;
    boolean start;
    public SmallerBall(Integer _itemID, ItemType _type, Model _model, Double _orix, Double _oriy, byte _weight) {
    ...
    public void draw(Canvas canvas) {
        ...
        Drawable d;
        d = model.getResources().getDrawable(R.drawable.minimizeball);
